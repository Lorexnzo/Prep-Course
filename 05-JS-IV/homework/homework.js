...
function tieneEmail (usuario) {
  ...
  // Tu código:
  var tiene = false;
  if (usuario.email != undefined) tiene = true;
  return tiene;
}
...
function tienePropiedad (objeto, propiedad) {
  ...
  // Tu código:
  var esIgual = false;
  //if (Object.keys(objeto)[0] == propiedad) esIgual = true; (otra forma de hacerlo)
  for (const key in objeto) {
    if (key == propiedad) esIgual = true;
  }
  return esIgual;
}
...
function verificarPassword (usuario, password) {
  ...
  // Tu código:
  var coinciden = false;
  if (usuario.password === password) coinciden = true;
  return coinciden;
}
